...
export const messages = {
  ua: {
    ...
    hero: {
      title: 'Технології\nдля кращого\nзавтра',
      text: 'Корпорація ЕНСІ — технологічна та інженерна компанія, що розробляє та впроваджує сучасні автоматизовані рішення, допомагаючи бізнесу працювати ефективніше, безпечніше та стабільніше',
    },
    about: {
      label: 'Про нас',
      title: 'Технології зі\nзмістом',
